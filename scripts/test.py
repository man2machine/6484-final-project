...
import torch
import numpy as np
from models.utils import evaluate_on_env, get_d4rl_normalized_score, get_d4rl_dataset_stats
...
if __name__ == "__main__":
    ...
    parser.add_argument('--chk_pt_dir', type=str, default='/home/gridsan/skarnik/6484-final-project/dt_runs/')
