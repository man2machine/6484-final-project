...
class LSTMDecisionTransformer(nn.Module):
    def __init__(self, state_dim, act_dim, n_blocks, h_dim, context_len, drop_p, max_timestep=4096):
        ...
        self.seq_model = nn.LSTM(input_size=h_dim, hidden_size=h_dim, dropout=drop_p,
            num_layers=n_blocks, batch_first=True, bidirectional=False)
